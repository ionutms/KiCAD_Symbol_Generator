...
def generate_files_for_series(
    ...
    """
    if series_name not in symbol_transformer_specs.SERIES_SPECS:
        msg = f"Unknown series: {series_name}"
        raise ValueError(msg)

    specs = symbol_transformer_specs.SERIES_SPECS[series_name]
...
if __name__ == "__main__":
    try:
        ...
        for series in symbol_transformer_specs.SERIES_SPECS:
