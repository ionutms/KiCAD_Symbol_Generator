...
SYMBOLS_SPECS: dict[str, SeriesSpec] = {
    "XAL1010": SeriesSpec(
        ...
        inductance_values=[
            0.22, 0.45, 0.68, 1.0, 1.5, 2.2, 3.3, 4.7, 5.6,
            6.8, 8.2, 10.0, 15.0],
        max_dc_current=[
            55.5, 53.0, 48.0, 43.5, 40.5, 32.0, 25.0, 24.0, 21.2,
            18.5, 17.1, 15.5, 13.8],
        max_dc_resistance=[
            0.5, 0.72, 0.96, 1.1, 1.76, 2.8, 4.1, 5.7, 6.93,
            8.9, 12.9, 14.75, 18.6],
        value_suffix="ME",
    ...
    "XAL6060": SeriesSpec(
        ...
        max_dc_current=[
            11.0, 10.0, 9.0, 8.0, 7.0, 6.0, 5.0, 3.6],
        max_dc_resistance=[
            14.4, 15.9, 20.8, 26.4, 29.82, 43.75, 60.63, 105.0],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XAL7020": SeriesSpec(
        manufacturer="Coilcraft",
    ...
    "XAL7030": SeriesSpec(
        ...
        inductance_values=[
            0.16, 0.3, 0.6, 1.0, 1.5, 2.2, 2.7, 3.3, 4.7,
            5.6, 6.8, 8.2, 10.0],
        max_dc_current=[
            32.5, 27.6, 23.0, 21.8, 15.0, 12.9, 11.4, 10.0, 9.0,
            7.3, 6.8, 5.9, 5.3],
        max_dc_resistance=[
            1.26, 1.92, 3.3, 5.0, 8.36, 15.07, 17.3, 21.45, 30.0,
            32.32, 51.75, 60.94, 69.46],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XAL7050": SeriesSpec(
        manufacturer="Coilcraft",
    ...
    "XAL8080": SeriesSpec(
        ...
        inductance_values=[
            0.68, 0.84, 1.0, 2.2, 4.7, 6.8, 10.0, 12.0, 15.0,
            18.0, 22.0, 33.0, 47.0],
        max_dc_current=[
            37.0, 35.0, 34.1, 21.5, 14.6, 11.3, 8.7, 10.5, 9.4,
            8.3, 7.6, 6.0, 4.8],
        max_dc_resistance=[
            1.65, 1.90, 2.33, 4.49, 9.77, 14.5, 23.1, 18.2, 22.5,
            28.0, 32.9, 48.5, 71.8],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XFL2005": SeriesSpec(
        ...
        inductance_values=[
            0.15, 0.22, 0.33, 0.47, 0.68, 1.0, 1.5, 2.2, 3.3,
            4.7, 5.6, 6.8, 8.2, 10.0],
        max_dc_current=[
            1.60, 1.48, 1.30, 1.25, 1.05, 0.84, 0.70, 0.66, 0.50,
            0.41, 0.39, 0.38, 0.33, 0.29],
        max_dc_resistance=[
            0.098, 0.128, 0.166, 0.204, 0.247, 0.43, 0.555, 0.775, 1.06,
            1.69, 1.98, 2.21, 2.8, 3.1],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XFL2006": SeriesSpec(
        manufacturer="Coilcraft",
        ...
        inductance_values=[
            1.0, 2.2, 3.3, 4.7, 5.6, 6.8, 8.2, 10.0, 15.0,
            22.0, 33.0, 47.0, 56.0, 68.0, 82.0, 100.0],
        max_dc_current=[
            1.22, 0.950, 0.72, 0.66, 0.6, 0.52, 0.49, 0.44, 0.35,
            0.305, 0.205, 0.205, 0.195, 0.155, 0.165, 0.135],
        max_dc_resistance=[
            0.169, 0.306, 0.506, 0.732, 0.825, 1.02, 1.19, 1.4, 2.22,
            3.06, 4.9, 5.16, 7.32, 9.35, 10.18, 12.25],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XFL2010": SeriesSpec(
        manufacturer="Coilcraft",
        ...
        inductance_values=[
            ...
            3.3, 4.7, 6.8, 8.2, 10.0, 18.0, 22.0, 33.0, 47.0,
            56.0, 68.0, 82.0, 100.0, 220.0],
        max_dc_current=[
            4.8, 3.7, 3.1, 2.85, 2.35, 2.15, 1.8, 1.55, 1.35,
            1.2, 0.91, 0.79, 0.76, 0.67, 0.46, 0.42, 0.35, 0.31,
            0.27, 0.26, 0.21, 0.2, 0.14],
        max_dc_resistance=[
            0.016, 0.022, 0.025, 0.033, 0.054, 0.061, 0.083, 0.115, 0.156,
            0.213, 0.32, 0.405, 0.511, 0.595, 1.17, 1.50, 2.14, 2.91,
            3.66, 3.98, 5.81, 6.98, 13.66],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XFL3010": SeriesSpec(
        manufacturer="Coilcraft",
    ...
    "XFL3012": SeriesSpec(
        ...
        inductance_values=[
            ...
            10.0, 15.0, 22.0, 33.0, 39.0, 47.0, 56.0, 68.0, 82.0,
            100.0, 220.0],
        max_dc_current=[
            3.5, 3.0, 2.8, 2.6, 2.2, 1.9, 1.6, 1.4, 1.3,
            1.2, 1.0, 0.80, 0.57, 0.54, 0.46, 0.44, 0.42, 0.34,
            0.39, 0.23],
        max_dc_resistance=[
            0.027, 0.032, 0.04, 0.046, 0.072, 0.097, 0.127, 0.171, 0.2,
            0.306, 0.483, 0.63, 0.896, 0.985, 1.32, 1.52, 1.985, 2.44,
            3.0, 3.07],
        value_suffix="ME",
        trustedparts_link="https://www.trustedparts.com/en/search"),
    "XFL4012": SeriesSpec(
