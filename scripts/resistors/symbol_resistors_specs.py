...
YAGEO_SYMBOLS_SPECS: Final[dict[str, SeriesSpec]] = {
    ...
    "RT0805BRE07": SeriesSpec(
        ...
        excluded_values=[
            ...
            909000, 910000, 931000, 953000, 976000, 1070000, 1540000, 1580000,
            1600000, 1620000, 1650000, 1690000, 1740000, 1780000, 1800000,
            1820000, 1870000, 1910000, 1960000, 2000000, 2050000, 2100000,
            2150000, 2200000, 2210000, 2260000, 2320000, 2370000, 2400000,
            2430000, 2490000, 2550000, 2610000, 2670000, 2700000, 2740000,
            2800000, 2870000, 2940000, 3000000],
        tolerance_map={"E96": "0.1%", "E24": "0.1%"},
        datasheet=(
            "https://www.yageo.com/en/ProductSearch/"
            "PartNumberSearch?part_number="),
    ...
    "RT0805CRE07": SeriesSpec(
        ...
        excluded_values=[
            ...
            665000, 680000, 681000, 698000, 715000, 732000, 750000, 768000,
            787000, 806000, 820000, 825000, 845000, 866000, 887000, 909000,
            910000, 931000, 953000, 976000, 1070000, 1100000, 1130000,
            1150000, 1180000, 1200000, 1210000, 1240000, 1270000, 1300000,
            1330000, 1370000, 1400000, 1430000, 1470000, 1500000, 1540000,
            1580000, 1600000, 1620000, 1650000, 1690000, 1740000, 1780000,
            1800000, 1820000, 1870000, 1910000, 1960000, 2000000, 2050000,
            2100000, 2150000, 2200000, 2210000, 2260000, 2320000, 2370000,
            2400000, 2430000, 2490000, 2550000, 2610000, 2670000, 2700000,
            2740000, 2800000, 2870000, 2940000, 3000000,
        ],
        datasheet=(
            "https://www.yageo.com/en/ProductSearch/"
            "PartNumberSearch?part_number="),
    ...
    "RT0805DRE07": SeriesSpec(
        ...
        excluded_values=[
            ...
            1470000, 1540000, 1580000, 1600000, 1620000, 1650000, 1690000,
            1740000, 1780000, 1800000, 1820000, 1870000, 1910000, 1960000,
            2000000, 2050000, 2100000, 2150000, 2200000, 2210000, 2260000,
            2320000, 2370000, 2400000, 2430000, 2490000, 2550000, 2610000,
            2670000, 2700000, 2740000, 2800000, 2870000, 2940000, 3000000],
    ...
    "RT0805FRE07": SeriesSpec(
        ...
        excluded_values=[
            ...
            1430000, 1470000, 1540000, 1580000, 1600000, 1620000, 1650000,
            1690000, 1740000, 1780000, 1800000, 1820000, 1870000, 1910000,
            1960000, 2000000, 2050000, 2100000, 2150000, 2200000, 2210000,
            2260000, 2320000, 2370000, 2400000, 2430000, 2490000, 2550000,
            2610000, 2670000, 2700000, 2740000, 2800000, 2870000, 2940000,
            3000000,
        ],
        tolerance_map={"E96": "1%", "E24": "1%"},
        datasheet=(
