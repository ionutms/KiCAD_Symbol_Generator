...
SERIES_SPECS: dict[str, SeriesSpec] = {
    ...
    "MMSZ52": SeriesSpec(
        ...
        voltage_rating=[
            ...
            4.3, 4.7, 5.0, 5.6, 6.2, 6.8, 7.5, 8.2, 9.1,
            11.0, 13.0, 14.0, 16.0, 20.0,
            68.0, 75.0, 82.0, 91.0, 100.0, 110.0, 120.0, 130.0,
            140.0, 160.0, 180.0, 200.0, 220.0, 240.0, 270.0, 300.0,
            330.0, 360.0, 390.0, 430.0, 470.0,
        ],
